...
export default function ExhibitCard({ exhibit, showStatus = true, className = '' }: ExhibitCardProps) {
  ...
  return (
    <Link href={`/exhibits/${exhibit.slug}`} className="block">
      <div className={`museum-card hover:shadow-lg transition-shadow duration-200 cursor-pointer ${className}`}>
        {featuredImage && (
        ...
        <div className="p-6">
          ...
          <div className="mt-4">
            <div className="inline-flex items-center text-primary hover:text-primary-700 font-medium transition-colors duration-200">
              Learn More
